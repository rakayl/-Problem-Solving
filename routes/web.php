...
/*KLASIFIKASI*/
Route::resource('/klasifikasi-mesin', KlasMesinController::class)->middleware('auth');
Route::middleware(['auth'])->group(function () {
...
Route::get('/pegawai/pdf', [DataAnggotaController::class, 'cetak_pdf'])->middleware(['auth']);
Route::resource('/pegawai', DataAnggotaController::class)->middleware('auth');
